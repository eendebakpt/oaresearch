...
if 0:
    afile='/home/eendebakpt/misc/homepage/oapage/tpages/classdata-special-36.2-2-2-2-2-2-t2/class-36.2-2-2-2-2-2-t2selection.oa.gz'
    #afile='/home/eendebakpt/misc/homepage/oapage/tpages/abdata-36.2-2-2-2-2-t2/class-36.2-2-2-2-2-t2selection.oa.gz'
    arrayclass=oalib.arraylink2arraydata(sols[0], strength=2)
...
if 1:
    picturedir=mkdirc('/home/eendebakpt/tmp/pics')
    #picturedir=mkdirc('/home/eendebakpt/Dropbox/OA2ndorder/images/nonregular')
